...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      ...
      List<String> managedPackages = List.of("org.springframework.samples.petclinic.model", "org.springframework.samples.petclinic.owner", "org.springframework.samples.petclinic", "org.springframework.samples.petclinic.system", "org.springframework.samples.petclinic.vet");
