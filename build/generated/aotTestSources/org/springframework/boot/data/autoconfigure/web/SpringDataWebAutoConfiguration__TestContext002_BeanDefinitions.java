...
public class SpringDataWebAutoConfiguration__TestContext002_BeanDefinitions {
  /**
   * Get the bean instance supplier for 'org.springframework.boot.data.autoconfigure.web.SpringDataWebAutoConfiguration'.
   */
  ...
  private static BeanInstanceSupplier<PageableHandlerMethodArgumentResolverCustomizer> getPageableCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<PageableHandlerMethodArgumentResolverCustomizer>forFactoryMethod(SpringDataWebAutoConfiguration.class, "pageableCustomizer")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.data.autoconfigure.web.SpringDataWebAutoConfiguration", SpringDataWebAutoConfiguration.class).pageableCustomizer());
  }
  ...
  public static BeanDefinition getPageableCustomizerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.data.autoconfigure.web.SpringDataWebAutoConfiguration");
  ...
  private static BeanInstanceSupplier<SortHandlerMethodArgumentResolverCustomizer> getSortCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<SortHandlerMethodArgumentResolverCustomizer>forFactoryMethod(SpringDataWebAutoConfiguration.class, "sortCustomizer")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.data.autoconfigure.web.SpringDataWebAutoConfiguration", SpringDataWebAutoConfiguration.class).sortCustomizer());
  }
  ...
  private static BeanInstanceSupplier<SpringDataWebSettings> getSpringDataWebSettingsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<SpringDataWebSettings>forFactoryMethod(SpringDataWebAutoConfiguration.class, "springDataWebSettings")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.data.autoconfigure.web.SpringDataWebAutoConfiguration", SpringDataWebAutoConfiguration.class).springDataWebSettings());
  }
