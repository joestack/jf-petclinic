...
public class TomcatWebServerConfiguration__TestContext004_BeanDefinitions {
  ...
  private static BeanInstanceSupplier<TomcatWebServerFactoryCustomizer> getTomcatWebServerFactoryCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<TomcatWebServerFactoryCustomizer>forFactoryMethod(TomcatWebServerConfiguration.class, "tomcatWebServerFactoryCustomizer", Environment.class, ServerProperties.class, TomcatServerProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.tomcat.autoconfigure.TomcatWebServerConfiguration", TomcatWebServerConfiguration.class).tomcatWebServerFactoryCustomizer(args.get(0), args.get(1), args.get(2)));
  }
