...
public class SslHealthContributorAutoConfiguration__TestContext002_BeanDefinitions {
  ...
  private static BeanInstanceSupplier<SslHealthIndicator> getSslHealthIndicatorInstanceSupplier() {
    return BeanInstanceSupplier.<SslHealthIndicator>forFactoryMethod(SslHealthContributorAutoConfiguration.class, "sslHealthIndicator", SslInfo.class, SslHealthIndicatorProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.ssl.SslHealthContributorAutoConfiguration", SslHealthContributorAutoConfiguration.class).sslHealthIndicator(args.get(0), args.get(1)));
  }
  ...
  private static BeanInstanceSupplier<SslInfo> getSslInfoInstanceSupplier() {
    return BeanInstanceSupplier.<SslInfo>forFactoryMethod(SslHealthContributorAutoConfiguration.class, "sslInfo", SslBundles.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.ssl.SslHealthContributorAutoConfiguration", SslHealthContributorAutoConfiguration.class).sslInfo(args.get(0)));
  }
